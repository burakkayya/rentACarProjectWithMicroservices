...
public class InventoryProducer {
    ...
    public void sendMessage(CarCreatedEvent event){
        log.info(String.format("car-created event => %s", event.getCarId()));
    ...
    public void sendMessage(CarDeletedEvent event){
        log.info(String.format("car-deleted event => %s", event.getCarId()));
    ...
    public void sendMessage(BrandDeletedEvent event){
        log.info(String.format("brand-deleted event => %s", event.getCarId()));
